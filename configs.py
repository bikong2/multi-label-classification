...
# 数据集
FLAGS.train_set_dir = 'dataset/test_sample'  # '/cache/zhengyuwei/new_plate_images'
FLAGS.train_label_path = 'dataset/test_sample/label.txt'  # '/cache/zhengyuwei/new_plate_images/train.txt'
FLAGS.test_set_dir = 'dataset/test_sample'  # '/cache/zhengyuwei/new_plate_images'
...
FLAGS.output_shapes = (34, 64, 34, 34, 34, 34, 42, 12, 2, 6)
FLAGS.output_names = ['char_{}'.format(i+1) for i in range(8)] + ['char_num', 'plate_color']
